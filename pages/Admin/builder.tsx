...
function builder() {
  return (
    <div className="container m-auto">
      <div className="relative mx-auto mt-10 flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between border rounded">
      ...
      <div className="border shadow rounded container m-auto max-w-screen-lg">
        ...
        </div>  <div className="flex justify-between mx-12 border-b my-2">
          <div className="flex ml-3 gap-3">
            <img
