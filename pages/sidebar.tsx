...
function sidebar() {
  return (
    <aside className="h-screen  md:relative">
    ...
    >
      ...
      <ul className="mt-8 space-y-3 md:mt-20">
        <li className="relative">
          <button className="focus:bg-slate-600 hover:bg-slate-600 flex w-full space-x-2 rounded-md px-10 py-4 text-white focus:outline-none">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
