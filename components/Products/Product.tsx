...
function Product() {
  ...
  return (
    <>
      ...
      {product && (
        <Head>
          <title>{query.productId}</title>
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <meta name="description" content={`${product[0]?.description}`} />
          <meta name="keywords" content={`${product[0]?.name}`} />
        </Head>
      )}
          ...
          {loading ? (
            ...
            <>
              {product?.map((item: any, index: number) => {
                const emifloat = (Number(item.price) + 5000) / 12;
                              ...
                              <div className="flex flex-wrap flex-row justify-between items-center border-b pb-5 pt-3">
                                <div>
                                  ...
                                  <h1 className="text-gray-600 text-sm">
                                    Have question about this product? Get
                                    specific details about this product from
                                    expert.
                                  </h1>
                                </div>
                                <button
                              ...
                              <div>
                                <div className="flex flex-col justify-center items-center">
                                  ...
                                  <p className="text-sm py-5">
                                    There are no questions asked yet. Be the
                            ...
                            <div className="p-5 rounded bg-white">
                              ...
                              <div>
                                <div className="flex flex-col justify-center items-center">
                                  ...
                                  <p className="text-sm py-5">
                                    This product has no reviews yet. Be the
                                    first one to write a review.
                                  </p>
                                </div>
                              </div>
                            </div>
